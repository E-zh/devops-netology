...
--
-- Name: orders_new; Type: TABLE; Schema: public; Owner: netology
--
...
ALTER TABLE public.orders_new OWNER TO netology;
...
ALTER TABLE ONLY public.orders_new ATTACH PARTITION public.orders_1 FOR VALUES FROM (0) TO (499);
...
ALTER TABLE ONLY public.orders_new ATTACH PARTITION public.orders_2 FOR VALUES FROM (499) TO (99999);


ALTER TABLE public.orders_2 OWNER TO netology;

--
-- Name: orders_id_seq; Type: SEQUENCE; Schema: public; Owner: netology
--
...
ALTER TABLE public.orders_id_seq OWNER TO netology;

--
-- Name: orders_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: netology
--
...
--
-- Name: orders id; Type: DEFAULT; Schema: public; Owner: netology
--
...
--
-- Data for Name: orders; Type: TABLE DATA; Schema: public; Owner: netology
--
...
--
-- Name: orders_id_seq; Type: SEQUENCE SET; Schema: public; Owner: netology
--
...
--
-- Name: orders orders_pkey; Type: CONSTRAINT; Schema: public; Owner: netology
--
